 ...
 * The macros are prefixed with 'CONV_ACCEL_0_WEIGHT_SLAVE_'.
 * The prefix is the slave descriptor.
 */
#define CONV_ACCEL_0_WEIGHT_SLAVE_COMPONENT_TYPE Conv_Accel
#define CONV_ACCEL_0_WEIGHT_SLAVE_COMPONENT_NAME Conv_Accel_0
#define CONV_ACCEL_0_WEIGHT_SLAVE_BASE 0xff200001
#define CONV_ACCEL_0_WEIGHT_SLAVE_SPAN 1
#define CONV_ACCEL_0_WEIGHT_SLAVE_END 0xff200001

/*
 * Macros for device 'Conv_Accel_0_output_slave', class 'Conv_Accel'
 * The macros are prefixed with 'CONV_ACCEL_0_OUTPUT_SLAVE_'.
 * The prefix is the slave descriptor.
 */
#define CONV_ACCEL_0_OUTPUT_SLAVE_COMPONENT_TYPE Conv_Accel
#define CONV_ACCEL_0_OUTPUT_SLAVE_COMPONENT_NAME Conv_Accel_0
#define CONV_ACCEL_0_OUTPUT_SLAVE_BASE 0xff200002
#define CONV_ACCEL_0_OUTPUT_SLAVE_SPAN 1
#define CONV_ACCEL_0_OUTPUT_SLAVE_END 0xff200002

/*
 * Macros for device 'Conv_Accel_0_feat_map_in_slave', class 'Conv_Accel'
 * The macros are prefixed with 'CONV_ACCEL_0_FEAT_MAP_IN_SLAVE_'.
 * The prefix is the slave descriptor.
 */
#define CONV_ACCEL_0_FEAT_MAP_IN_SLAVE_COMPONENT_TYPE Conv_Accel
#define CONV_ACCEL_0_FEAT_MAP_IN_SLAVE_COMPONENT_NAME Conv_Accel_0
#define CONV_ACCEL_0_FEAT_MAP_IN_SLAVE_BASE 0xff200003
#define CONV_ACCEL_0_FEAT_MAP_IN_SLAVE_SPAN 1
#define CONV_ACCEL_0_FEAT_MAP_IN_SLAVE_END 0xff200003

/*
 * Macros for device 'Conv_Accel_0_control_slave', class 'Conv_Accel'
 * The macros are prefixed with 'CONV_ACCEL_0_CONTROL_SLAVE_'.
 * The prefix is the slave descriptor.
 */
#define CONV_ACCEL_0_CONTROL_SLAVE_COMPONENT_TYPE Conv_Accel
#define CONV_ACCEL_0_CONTROL_SLAVE_COMPONENT_NAME Conv_Accel_0
#define CONV_ACCEL_0_CONTROL_SLAVE_BASE 0xff200004
#define CONV_ACCEL_0_CONTROL_SLAVE_SPAN 1
#define CONV_ACCEL_0_CONTROL_SLAVE_END 0xff200004

/*
 * Macros for device 'Conv_Accel_0_output_flag', class 'Conv_Accel'
 * The macros are prefixed with 'CONV_ACCEL_0_OUTPUT_FLAG_'.
 * The prefix is the slave descriptor.
 */
#define CONV_ACCEL_0_OUTPUT_FLAG_COMPONENT_TYPE Conv_Accel
#define CONV_ACCEL_0_OUTPUT_FLAG_COMPONENT_NAME Conv_Accel_0
#define CONV_ACCEL_0_OUTPUT_FLAG_BASE 0xff200005
#define CONV_ACCEL_0_OUTPUT_FLAG_SPAN 1
#define CONV_ACCEL_0_OUTPUT_FLAG_END 0xff200005
...
#define SYSID_QSYS_TIMESTAMP 1633322826
 ...
 * The macros are prefixed with 'SIMPLE_INC_0_'.
 * The prefix is the slave descriptor.
 */
#define SIMPLE_INC_0_COMPONENT_TYPE simple_inc
#define SIMPLE_INC_0_COMPONENT_NAME simple_inc_0
#define SIMPLE_INC_0_BASE 0xff2100d0
#define SIMPLE_INC_0_SPAN 4
#define SIMPLE_INC_0_END 0xff2100d3
